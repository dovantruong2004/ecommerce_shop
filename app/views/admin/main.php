                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">
                                        <h4 class="card-title"><?php foreach ($so_don_dadat as $so_don) { ?>
                                ...
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">
                                        ...
                                        <?php foreach ($doanh_thu_ngay as $doanh_thu) { ?>
                                            <?php if ($doanh_thu_ngay == null) { ?>
                                                <p>0 VNĐ</p>
                                            <?php } else { ?>
                                                <p><?php echo $doanh_thu['doanh_thu'] ?> VNĐ</p>
                                            <?php } ?>
                                        <?php } ?>
                                    </h4>
                                </div>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    <p class="card-category">Tổng doanh thu theo tháng</p>
                                    <h4 class="card-title">

                                        <?php foreach ($doanh_thu_thang as $doanh_thu) { ?>
                                            <?php if ($doanh_thu_thang == null) { ?>
                                                <p>0 VNĐ</p>
                                            <?php } else { ?>
                                                <p><?php echo $doanh_thu['doanh_thu'] ?> VNĐ</p>
                                            <?php } ?>
