...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">Gửi khiếu nại</h5>
                        <form action="">
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    ...
                    by
                    <a class="text-dark font-weight-semi-bold" href="#">HTML Codex</a>
                </p>
            </div>
    ...
    <script src="../../../public/style/khachhang/assets/lib/easing/easing.min.js"></script>
    <script src="../../../public/style/khachhang/assets/../../../public/style/khachhang/assets/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="../../../public/style/khachhang/assets/mail/jqBootstrapValidation.min.js"></script>
    <script src="../../../public/style/khachhang/assets/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="../../../public/style/khachhang/assets/js/main.js"></script>
</body>
